...
Phew! That was a lot of information, but try to commit as much of it as possible to _memory_! Ha ha ha, I've been waiting all this time to drop that pun on you. Now that we know all about computer hardware, let's go shopping!!1!
